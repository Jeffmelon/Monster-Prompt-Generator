let promptList = [{name: "Adze", description: "A Vampiric Firefly from African Mythology"},
    ...
    {name: "Apple of Discord", description: "The golden apple thrown by Eris goddess of chaos"},
    ...
    {name: "Gibbet", description: "A cage in which prisoners would be put to deter others from crime."},
    ...
    {name: "Hocus", description: "A small witches hat with a pair of legs"},
    ...
    {name: "Pocus", description: "A witch’s familiar that appears as a bubbling cauldron with a small pair of legs."},
